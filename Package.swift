...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "libOpen3D.a", url: "https://github.com/windcludy/Open3D-iOS/releases/download/0.0.20240512110206/libOpen3D.a.xcframework1.zip", checksum: "556fedabfd934ee63cb4340aaa377c80d9fd630c5e2874923124a63fb3ed7cb8"),
