...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "ibvtkCommonMisc", url: "https://github.com/windcludy/Open3D-iOS/releases/download/0.0.20240512110206/VTK_common_misc.zip", checksum: "4e551d2f7a29f4c2abf8ebed60435d567da37b8ef15d175b3edb2cafca5d396e"),
